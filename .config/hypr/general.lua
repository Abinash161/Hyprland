...
-- hl.workspace_rule({ workspace = "w[tv1]", gaps_out = 5, gaps_in = 4 })
-- hl.workspace_rule({ workspace = "f[2]",   gaps_out = 10, gaps_in = 5 })
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = { "rgba(ffffffff)", "rgba(00000000)" }, angle = 45 },
